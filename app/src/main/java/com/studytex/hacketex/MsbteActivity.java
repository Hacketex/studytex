...
public class MsbteActivity extends AppCompatActivity {
	
	
	private LinearLayout linear1;
	private WebView msbte_result;
	private TextView textview1;
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.msbte);
	...
	private void initializeLogic() {
		msbte_result.loadUrl("https://msbte.org.in/SHTFNL20BTERESLIVE/frmWIN20BTERESDisplay.aspx");
	}
